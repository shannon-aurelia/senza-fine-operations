...
export function PurchasingView({ data, submit, onRefresh }: { data: SheetData; submit: SubmitAction; onRefresh: () => void }) {
  ...
  const visibleGroups = tab === "Review" ? requestGroups.filter((group) => group.status === "Submitted") : tab === "Approval" ? requestGroups.filter((group) => group.status === "Reviewed") : requestGroups;
  return <section className="module-page">
